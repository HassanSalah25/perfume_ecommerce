...
@section('content')
    <section class="bg-light pt-20 pb-20 mt75 sm-mt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <ul class="crumb m-0">
                        ...
                        @if (isset($product))
                            <li class="active">{{ $product->getTranslation('name') }}</li>
                        @elseif (isset($category))
                            <li class="active">{{ $category->getTranslation('name') }}</li>
                        @else
                            <li class="active">{{ translate('Shop') }}</li>
                        @endif
                    </ul>
                </div>
            </div>
